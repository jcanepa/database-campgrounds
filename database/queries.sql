...
insert into campgrounds (`national_park`, `name`, `location`, `check_in_time`, `check_out_time`, `open_season`, `map_image_url`) values
    ...
    ('Joshua Tree', 'Cottonwood', 'NW corner of the park', '2PM', '11AM', 'Spring, Summer, Fall', 'https://www.nps.gov/jotr/planyourvisit/images/Black-Rock-Campground-web-Schwalbe_1.jpg'),
...
insert into campsites (`campground_id`, `site_number`, `type`, `fee`, `capacity`, `vehicle_capacity`, `is_reservable`) values
    (1, 001, 'tent only, non-electric', 2500, 6, 1, 0),
    (1, 002, 'tent only, non-electric', 2500, 6, 1, 1),
    (1, 003, 'standard, non-electric', 2500, 4, 1, 1),
